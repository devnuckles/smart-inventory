...
func serveRest() {
	...
	supplierRepo := repo.NewSupplierRepo(ddbClient, tableConfig.SupplierTableName)
	...
	svc := service.NewService(userRepo, productRepo, fileRepo, errorRepo, cache, authorization, orderRepo, smtpConfig, supplierRepo)
